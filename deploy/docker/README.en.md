...
> For cluster operation see [`../kubernetes/`](../kubernetes/) (manifests +
> Helm chart); without a container runtime the classic installation via
> `config/` (systemd + nginx) remains available.
