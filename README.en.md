...
- **N+1 failover reserve** (`--failover-hosts`), **vSAN factor** for usable net capacity, VM **exclusion by tag**, **minimum LUN size** (exclude small boot/ISO datastores entirely; Administration → Storage)
